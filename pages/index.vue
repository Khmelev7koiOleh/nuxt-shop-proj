...
<template>
  <NuxtLink to="/products" class="w-full flex justify-center">
    <div
      :class="
        onValueChange
      ...
      "
      class="justify-around flex absolute mx-auto"
    >
      <img
        class="min-w-[90vw] min-h-[50vh] md:max-h-[80vh] mx-auto md:flex md:justify-center object-cover"
        :src="randomImage"
      />
    </div>
    <div
    ...
    >
      <img
        class="min-w-[90vw] min-h-[50vh] md:max-h-[80vh] mx-auto md:flex object-cover"
        :src="randomImageTwo"
      />
    </div>
  </NuxtLink>
  <div class="py-[25vh] md:py-[40vh]"></div>
  ...
  <div class="py-20">
    ...
    <NuxtLink to="/products" class="w-full">
      <div class="basis-1/3 flex max-w-[100%] mx-auto">
        <img class="max-w-[30vw] mx-auto md:flex hidden" :src="randomImage" />

        <img
          class="max-w-[90vw] md:max-w-[30vw] mx-auto md:flex"
          :src="randomImageTwo"
        />

        <img
          class="max-w-[30vw] mx-auto md:flex hidden"
